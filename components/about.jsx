...
export function About(){
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto clear-start">
        ...
        <div className=''>
        <p className="text-sm text-gray-900 dark:text-gray-200" style={{ textAlign: 'justify', lineHeight: '22px' }}>
                Soy Kerwin Angeles Flores, un desarrollador <span className='font-bold' style={{color: '#FACC15'}}> Frontend </span> apasionado por la tecnología y la creación de soluciones innovadoras. 
